...
class ClipTextFeatureEncoder(nn.Module):
    ...
    def __init__(self, in_features, down_sample='pooling', clip_vision_encoder_path="ViT-L-14", clip_vision_encoder_pretrained="openai", **kwargs):
        super().__init__()
        
        self.model, self.img_preprocess, self.vis_dim = clip_vision_encoder(clip_vision_encoder_path, clip_vision_encoder_pretrained)
    ...
    def loss(self, output_hs, clip_text_ids):
        ...
        if output_hs.ndim > clip_text_feats.ndim:
            ...
            clip_text_feats = repeat(clip_text_feats, 'b d -> b l d', l=output_hs.shape[1])
...
if __name__ == "__main__":
    ...
    model = ClipTextFeatureEncoder(in_features, clip_vision_encoder_path, clip_vision_encoder_pretrained)
    import open_clip
