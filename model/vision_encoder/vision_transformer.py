...
class VisionTransformer(nn.Module):
    ...
    def __init__(self, clip_vision_encoder_path, clip_vision_encoder_pretrained, resampler=None):
        super().__init__()
        self.vision_encoder, _ = clip_vision_encoder(clip_vision_encoder_path, clip_vision_encoder_pretrained)
