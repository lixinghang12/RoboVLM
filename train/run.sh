...
sudo chmod 777 -R /mnt/bn/robotics-data-hl/gr_training/logs
sudo chmod 777 -R /mnt/bn/robotics-data-hl/gr_training/checkpoints
...
pip3 install flamingo_pytorch -i "https://bytedpypi.byted.org/simple"
