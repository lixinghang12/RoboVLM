...
def build_tokenizer(tokenizer_config):
    ...
    try:
        tokenizer = getattr(transformers, tokenizer_type).from_pretrained(tokenizer_path, local_files_only=tokenizer_config.get('use_local_files', False), trust_remote_code=True)
